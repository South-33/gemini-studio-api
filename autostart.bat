...
:: Start the API (with unbuffered output, keep window visible to prevent Windows console suspension)
echo [2/3] Starting API server on port %PORT%...
start "GeminiAPI" cmd /c "set PYTHONUNBUFFERED=1 && python -u main.py"
